...
- Acessibilidade (ARIA, keyboard nav, contrast)
- Consistencia de API de componentes
- Performance (memoization, re-renders)
- Conformidade com SCSS + BEM
...
> **PR:** [feat(payments): add average ticket stat card](LINK_PR_PAYMENTS)
...
> **PR:** [feat(admin): add reset button](LINK_PR_ADMIN)
